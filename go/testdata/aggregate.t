...
any:sub-27-1 = { ip = 10.1.2.128/25; link = network:n3; }
# Is not shown in warning, because it is assumed to aggregate
# its enclosed networks.
any:sub-27-2 = { ip = 10.1.2.0/25; link = network:n3; }
network:n2-sub-a = { ip = 10.1.2.32/27; subnet_of = network:n2; }
network:n2-sub-b = { ip = 10.1.2.64/27; subnet_of = network:n2; }
