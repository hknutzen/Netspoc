...
ip access-list extended inet_in
 ...
 permit tcp 0.0.0.0 7.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 8.0.0.0 1.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 11.0.0.0 0.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 12.0.0.0 3.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 16.0.0.0 15.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 32.0.0.0 31.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 64.0.0.0 63.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 128.0.0.0 31.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 160.0.0.0 7.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 168.0.0.0 3.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 172.0.0.0 0.15.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 172.32.0.0 0.31.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 172.64.0.0 0.63.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 172.128.0.0 0.127.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 173.0.0.0 0.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 174.0.0.0 1.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 176.0.0.0 15.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 192.0.0.0 0.127.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 192.128.0.0 0.31.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 192.160.0.0 0.7.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 192.169.0.0 0.0.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 192.170.0.0 0.1.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 192.172.0.0 0.3.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 192.176.0.0 0.15.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 192.192.0.0 0.63.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 193.0.0.0 0.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 194.0.0.0 1.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 196.0.0.0 3.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 200.0.0.0 7.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 208.0.0.0 15.255.255.255 10.1.1.0 0.0.0.255 eq 80
 permit tcp 224.0.0.0 31.255.255.255 10.1.1.0 0.0.0.255 eq 80
 deny ip any any
=END=
