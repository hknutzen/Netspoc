...
- IPv6 part of group of dual stack virtual interfaces was not marked
  as redundancy group, leading to unexpected error message.
...
- Attribute 'subnet_of' of dual stack loopback interface now works correctly
  in case of subnet relation is holding for IPv4 and IPv6.
...
- Program "export-netspoc" exports visible services again.
