...
{% include image.html src="./images/crosslink_need_protect.png" description="As no filtering takes place at IF1 and IF4, routers R1 and R2 need to filter packets for IF 1-4." %}
